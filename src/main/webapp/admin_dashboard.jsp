...
<nav>
    <div class="nav-left">
        ...
        <a href="manage_donors.jsp">Manage Donors</a>
        <a href="manage_officers.jsp">Manage Officers</a>
        <a href="manage_camps.jsp">Manage Blood Camps</a>
        <a href="view_requests.jsp">View Requests</a>
    </div>
    <div class="nav-right">
